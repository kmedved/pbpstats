...
def render_architecture_markdown(sync_data: Dict[str, object]) -> str:
    ...
    lines = [
        ...
        "- Live enhanced PBP recomputes shot clock after defensive rebound team-id normalization; moving that second pass changes live possession semantics. (`pbpstats/data_loader/live/enhanced_pbp/loader.py`, `tests/test_shot_clock.py`)",
